...
am__DIST_COMMON = $(doc_automake_TEXINFOS) \
	...
	$(srcdir)/contrib/t/local.mk $(srcdir)/doc/local.mk \
	$(srcdir)/lib/Automake/local.mk $(srcdir)/lib/am/local.mk \
	$(srcdir)/lib/local.mk $(srcdir)/m4/local.mk \
	$(srcdir)/pre-inst-env.in $(srcdir)/t/CheckListOfTests.am \
	$(srcdir)/t/list-of-tests.mk $(srcdir)/t/local.mk \
	$(srcdir)/t/testsuite-part.am $(top_srcdir)/lib/compile \
	$(top_srcdir)/lib/config.guess $(top_srcdir)/lib/config.sub \
	$(top_srcdir)/lib/install-sh $(top_srcdir)/lib/mdate-sh \
	$(top_srcdir)/lib/missing $(top_srcdir)/lib/mkinstalldirs \
	$(top_srcdir)/lib/test-driver $(top_srcdir)/lib/texinfo.tex \
	AUTHORS COPYING ChangeLog INSTALL NEWS README THANKS \
	lib/COPYING lib/INSTALL lib/ar-lib lib/compile \
	lib/config.guess lib/config.sub lib/depcomp lib/install-sh \
	lib/mdate-sh lib/missing lib/mkinstalldirs lib/py-compile \
	lib/texinfo.tex lib/ylwrap
...
ACLOCAL = "/mnt/f/vishal/gsoc/automake-1.16.1/pre-inst-env" aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AM_TEST_RUNNER_SHELL = /bin/bash
APIVERSION = 1.16
AUTOCONF = ${SHELL} /mnt/f/vishal/gsoc/automake-1.16.1/lib/missing autoconf
AUTOHEADER = ${SHELL} /mnt/f/vishal/gsoc/automake-1.16.1/lib/missing autoheader
AUTOMAKE = "/mnt/f/vishal/gsoc/automake-1.16.1/pre-inst-env" automake-1.16
AWK = gawk
CC = cc
CFLAGS = -g -O2
CPPFLAGS = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /mnt/f/vishal/gsoc/automake-1.16.1/lib/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
VERSION = 1.16.1
YACC = yacc
abs_builddir = /mnt/f/vishal/gsoc/automake-1.16.1
abs_srcdir = /mnt/f/vishal/gsoc/automake-1.16.1
abs_top_builddir = /mnt/f/vishal/gsoc/automake-1.16.1
abs_top_srcdir = /mnt/f/vishal/gsoc/automake-1.16.1
ac_ct_CC = cc
ac_ct_CXX = c++
ac_ct_F77 = 
ac_ct_FC = 
...
install_sh = ${SHELL} /mnt/f/vishal/gsoc/automake-1.16.1/lib/install-sh
...
prefix = /mnt/f/vishal/gsoc/automake-1.16.1/buildfiles
...
$(srcdir)/bin/local.mk $(srcdir)/doc/local.mk $(srcdir)/lib/local.mk $(srcdir)/lib/Automake/local.mk $(srcdir)/lib/am/local.mk $(srcdir)/m4/local.mk $(srcdir)/t/local.mk $(srcdir)/t/list-of-tests.mk $(srcdir)/t/testsuite-part.am $(srcdir)/contrib/t/local.mk $(srcdir)/t/CheckListOfTests.am $(am__empty):
